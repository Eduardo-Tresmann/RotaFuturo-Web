            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="mb-8">
                ...
                <div className="flex justify-center mt-2 sm:mt-4 md:mt-6 h-12 sm:h-14 relative select-none user-select-none">
                  <Button
                    className="px-4 sm:px-6 py-2 sm:py-3 bg-blue-600 text-white text-sm sm:text-base font-medium rounded-lg shadow hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 transition w-full sm:w-auto select-none user-select-none"
                    onClick={handleNext}
                    onMouseDown={(e) => e.preventDefault()}
