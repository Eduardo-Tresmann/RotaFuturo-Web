...
export function HeaderHome({
  ...
  const navItems = hideDefaultNav ? customNavItems : [...defaultNavItems, ...(customNavItems || [])];
        ...
        <div className="flex items-center justify-between px-4 py-2">
          ...
          <div className="flex items-center space-x-3">
            <Sheet>
              ...
              <SheetContent side="right" className="bg-zinc-900/95 backdrop-blur text-zinc-100 border-zinc-800 w-[80vw] sm:w-[350px]">
