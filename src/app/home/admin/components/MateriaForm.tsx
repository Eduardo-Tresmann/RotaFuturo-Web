...
export default function MateriaForm() {
  const [form, setForm] = useState<Partial<Materia>>({
    matDescricao: '',
    area: undefined,
    areaSub: undefined,
  });
  ...
  return (
    <div className="bg-white rounded-2xl shadow-soft p-8 max-w-2xl mx-auto">
      <h2 className="text-2xl font-bold text-blue-700 mb-8 text-center">Cadastro de Matéria</h2>
